...
function resolveSpiderDebt(getFlag, setFlag) {
  if (!getFlag('spiderDebtPending')) {
    return;
  }

  setFlag('spiderDebtPending', false);
  setFlag('spiderDebtResolved', true);
}

function handleFeastHallAttack({ getFlag, setFlag }) {
  ...
  resolveSpiderDebt(getFlag, setFlag);
...
function handleBlackWindSabotage({ getFlag, setFlag }) {

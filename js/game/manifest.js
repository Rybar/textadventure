...
export function createGameManifest() {
  ...
  return {
    ...
    flags: {
      ...
      hasExperiencedGameOver: false,
      routineGameOverSeen: false,
      grandfatherBedGameOverSeen: false,
      correctionGameOverSeen: false,
      blackWindSapGameOverSeen: false,
      peafowlGameOverSeen: false,
      rubyEyesGameOverSeen: false,
      bloodHomunculusGameOverSeen: false,
      coinChestGameOverSeen: false,
      holocaustCandleGameOverSeen: false,
      oozeFormGameOverSeen: false,
